                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="role" id="roleCliente" value="cliente" checked>
                                <label class="form-check-label" for="roleCliente">
                                    Cliente - Acceso a la tienda y compras
                                </label>
                            </div>
                            <div class="form-check">
